...
import (
	...
	scheme "github.com/kminehart/ladon-resource-manager/pkg/client/clientset/versioned/scheme"
...
func newPolicies(c *LadoncontrollerV1alpha1Client, namespace string) *policies {
	return &policies{
		client: c.RESTClient(),
		ns:     namespace,
	}
